...
function getAll(req, res) {
    ...
    var sql = 'SELECT p.ProjectID, substring(p.ProjectName,1,30) as \'ProjectName\', substring(p.Description,1,60) as \'Description\', e.FullName, p.CreationDate, t.ProjectTypeName ';
